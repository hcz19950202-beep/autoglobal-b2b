  ...
  return (
    <div className="card-3d bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl border border-gray-100 group flex flex-col h-full">
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {isFeatured && (
          <div className="absolute top-3 left-3 bg-gradient-to-r from-amber-500 to-yellow-400 text-white text-[9px] sm:text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wider shadow-lg shadow-amber-500/30 flex items-center gap-1">
      ...
      <div className="p-4 sm:p-5 flex-grow flex flex-col">
        ...
        <div className="flex items-center text-gray-400 text-[10px] sm:text-xs gap-3 mb-3">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between gap-2">
          <div className="min-w-0">
            <span className="text-gray-400 text-[9px] sm:text-[10px] uppercase font-bold tracking-wider">{t('card.exportPrice')}</span>
